...
HD_PWD='E:/study/shixi/690t/HA-CJ_v1.00/SF51_JR6101_A1.runs/AXIS_sfifo_256X64_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXIS_sfifo_256X64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXIS_sfifo_256X64.tcl
