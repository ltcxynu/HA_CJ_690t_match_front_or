...
HD_PWD='E:/study/shixi/690t/HA-CJ_v1.00/SF51_JR6101_A1.runs/fifo512bit_1k_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo512bit_1k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo512bit_1k.tcl
