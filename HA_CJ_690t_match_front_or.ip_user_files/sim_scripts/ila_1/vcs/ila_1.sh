...
#
# Generated by Vivado on Tue Jun 18 10:30:55 +0800 2024
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../HA_CJ_690t_match.srcs/sources_1/ip/ila_1/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../HA_CJ_690t_match.srcs/sources_1/ip/ila_1/hdl/verilog" \
    "$ref_dir/../../../../HA_CJ_690t_match.srcs/sources_1/ip/ila_1/sim/ila_1.v" \
  2>&1 | tee -a vlogan.log
